...
public class SpawnHelperBlame {
    ...
    public static void addFeatureDetails(ServerWorld serverWorld, SpawnGroup entityClassification, BlockPos pos, Biome biome, List<SpawnSettings.SpawnEntry> list) {
